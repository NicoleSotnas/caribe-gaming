...
const mockRawgService = {
  obterDetalhesJogo: vi.fn().mockReturnValue(of({
    ...
    name: 'F1® 23',
    released: '2023-06-16',
    developers: [{ name: 'Codemasters' }],
    publishers: [{ name: 'EA Sports' }],
    platforms: [{ platform: { name: 'PC' } }],
    background_image: 'f123.jpg'
  })),
...
describe('Componente F1 - Testes de Cobertura Alta', () => {
  ...
  describe('Lógica de Métodos e Estado (Vitest)', () => {
    ...
    beforeEach(() => {
      ...
      const fixture = TestBed.createComponent(F1);
    ...
    it('deve inicializar o componente e carregar dados do jogo', () => {
      ...
      expect(component.jogo?.nome).toBe('F1® 23');
    ...
    it('deve manipular o modal de avaliação e validação de envio', () => {
      ...
      component.novoNome = 'Ayrton';
      component.novoTexto = 'Excelente física de controle!';
      component.enviarAvaliacao();
      expect(component.listaComentarios[0].autor).toBe('Ayrton');
    ...
    it('deve adicionar ao carrinho, favoritar e acionar comprar agora', () => {
      component.jogo = { nome: 'F1® 23', plataformas: 'PC' } as any;
  ...
  describe('Interface do Usuário (Testing Library)', () => {
    ...
    it('deve renderizar a página do jogo e checar comentários na tela', async () => {
      ...
      // Valida se o comentário padrão do Ayrton_Fan aparece visível na página
      const autorComentario = screen.getByText(/Ayrton_Fan/i);
