...
const CHAVE_CACHE = 'godofwar_dados_completos';
const CHAVE_AVALIACOES = 'godofwar_avaliacoes_lista';
...
@Component({
  ...
  styleUrl: './godofwar.css',
})
export class GodOfWar implements OnInit {
  ...
  listaComentarios: Comentario[] = [
    {
      ...
      avatar: 'K',
      estrelas: 5,
      texto: 'Uma obra-prima absoluta! A relação entre Kratos e Atreus traz uma carga dramática incrível para a franquia.',
      data: '22/08/2026',
      likes: 589,
      dislikes: 12,
    },
    {
      ...
      avatar: 'A',
      estrelas: 5,
      texto: 'Combate visceral, gráficos deslumbrantes e uma mitologia nórdica explorada de forma brilhante.',
      data: '19/08/2026',
      likes: 310,
      dislikes: 4,
    },
  ...
  private jogoSlug = 'god-of-war-2';
  private steamAppId = '1593500';
  ...
  adicionarAoCarrinho(): void {
    ...
    this.carrinhoFacade.adicionarProduto({
      ...
      plataforma: this.jogo.plataformas || 'PC / PS4',
    ...
    this.rawgService.obterDetalhesJogo(this.jogoSlug).subscribe({
      next: (res: any) => {
        this.jogo = {
          ...
          plataformas: res.platforms?.map((p: any) => p.platform.name).join(' / ') || 'PC / PS4',
