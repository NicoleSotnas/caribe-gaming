...
const mockRawgService = {
  obterDetalhesJogo: vi.fn().mockReturnValue(of({
    ...
    background_image: 'cyberpunk.jpg'
  })),
...
describe('Componente Cyberpunk2077 - Testes de Cobertura Alta', () => {
  ...
  describe('Lógica de Métodos e Estado (Vitest)', () => {
    ...
    beforeEach(() => {
      ...
      const fixture = TestBed.createComponent(Cyberpunk2077);
    ...
    it('deve inicializar o componente e carregar dados do jogo', () => {
      ...
      expect(component.jogo?.nome).toBe('Cyberpunk 2077');
    ...
    it('deve manipular o modal de avaliação e validação de envio', () => {
      ...
      component.novoNome = 'V';
      component.novoTexto = 'Night City é incrível!';
      component.enviarAvaliacao();
      expect(component.listaComentarios[0].autor).toBe('V');
    ...
    it('deve adicionar ao carrinho, favoritar e acionar comprar agora', () => {
      component.jogo = { nome: 'Cyberpunk 2077', plataformas: 'PC' } as any;
  ...
  describe('Interface do Usuário (Testing Library)', () => {
    ...
    it('deve renderizar a página do jogo e checar comentários na tela', async () => {
      ...
      // Valida se o comentário padrão de V_NightCity aparece visível na página
      const autorComentario = screen.getByText(/V_NightCity/i);
