...
const mockRawgService = {
  obterDetalhesJogo: vi.fn().mockReturnValue(of({
    ...
    publishers: [{ name: 'PlayStation Publishing LLC' }],
    platforms: [{ platform: { name: 'PC' } }],
    background_image: 'tlou1.jpg'
  })),
...
describe('Componente TheLastOfUs - Testes de Cobertura Alta', () => {
  ...
  describe('Lógica de Métodos e Estado (Vitest)', () => {
    ...
    beforeEach(() => {
      ...
      const fixture = TestBed.createComponent(TheLastOfUs);
    ...
    it('deve inicializar o componente e carregar dados do jogo', () => {
      ...
      expect(component.jogo?.nome).toBe('The Last of Us Part I');
    ...
    it('deve manipular o modal de avaliação e validação de envio', () => {
      ...
      component.novoNome = 'Joel';
      component.novoTexto = 'Remake impecável de um clássico absoluto!';
      component.enviarAvaliacao();
      expect(component.listaComentarios[0].autor).toBe('Joel');
    ...
    it('deve adicionar ao carrinho, favoritar e acionar comprar agora', () => {
      component.jogo = { nome: 'The Last of Us Part I', plataformas: 'PC' } as any;
  ...
  describe('Interface do Usuário (Testing Library)', () => {
    ...
    it('deve renderizar a página do jogo e checar comentários na tela', async () => {
      ...
      // Valida se o comentário padrão do JoelSurvivor aparece visível na página
      const autorComentario = screen.getByText(/JoelSurvivor/i);
