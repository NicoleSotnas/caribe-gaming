...
const CHAVE_CACHE = 'tlou_part1_dados_completos';
const CHAVE_AVALIACOES = 'tlou_part1_avaliacoes_lista';

@Component({
  selector: 'app-the-last-of-us',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './the-last-of-us.html',
  styleUrl: './the-last-of-us.css',
})
export class TheLastOfUs implements OnInit {
  ...
  listaComentarios: Comentario[] = [
    {
      ...
      avatar: 'J',
      estrelas: 5,
      texto: 'Uma verdadeira aula de narrativa e imersão. O remake deixou o jogo ainda mais lindo e emocionante!',
      data: '22/08/2026',
      likes: 410,
      dislikes: 3,
    },
    {
      ...
      avatar: 'E',
      estrelas: 5,
      texto: 'Trilha sonora marcante, jogabilidade tensa e uma história que te prende do início ao fim. Recomendadíssimo!',
      data: '20/08/2026',
      likes: 285,
      dislikes: 2,
    },
  ...
  private jogoSlug = 'the-last-of-us-part-i';
  private steamAppId = '1888930';
    ...
    this.rawgService.obterDetalhesJogo(this.jogoSlug).subscribe({
      next: (res: any) => {
        this.jogo = {
          ...
          descricao: `Conheça a emocionante história e os personagens inesquecíveis de The Last of Us, vencedor de mais de 200 prêmios de Jogo do Ano. Em uma civilização devastada, onde infectados e sobreviventes brutalizados correm soltos, Joel, um contrabandista calejado, é contratado para retirar Ellie, uma garota de 14 anos, de uma zona de quarentena militar. O que começa como um pequeno serviço logo se transforma em uma jornada brutal e emocionante pelos Estados Unidos. Inclui a história principal e o capítulo anterior à trama, Left Behind.`,
          dataLancamento: res.released ? res.released.split('-').reverse().join('/') : '02/09/2022',
