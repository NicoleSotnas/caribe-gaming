...
describe('Componente HollowKnight - Testes de Cobertura Alta', () => {
  ...
  describe('Lógica de Métodos e Estado (Vitest)', () => {
    ...
    beforeEach(() => {
      ...
      const fixture = TestBed.createComponent(HollowKnight);
    ...
    it('deve inicializar o componente e carregar dados do jogo', () => {
      ...
      expect(component.jogo?.nome).toBe('Hollow Knight');
    ...
    it('deve manipular o modal de avaliação e validação de envio', () => {
      ...
      component.novoNome = 'Knight';
      component.novoTexto = 'Uma obra-prima dos jogos indie!';
      component.enviarAvaliacao();
      expect(component.listaComentarios[0].autor).toBe('Knight');
    ...
    it('deve adicionar ao carrinho, favoritar e acionar comprar agora', () => {
      component.jogo = { nome: 'Hollow Knight', plataformas: 'PC' } as any;
  ...
  describe('Interface do Usuário (Testing Library)', () => {
    ...
    it('deve renderizar a página do jogo e checar comentários na tela', async () => {
      ...
      // Valida se o comentário padrão do Elderbug aparece visível na página
      const autorComentario = screen.getByText(/Elderbug/i);
