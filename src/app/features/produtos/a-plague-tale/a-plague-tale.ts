...
const CHAVE_CACHE = 'aplague_dados_completos';
const CHAVE_AVALIACOES = 'aplague_avaliacoes_lista';

@Component({
  selector: 'app-a-plague-tale',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './a-plague-tale.html',
  styleUrl: './a-plague-tale.css',
})
export class APlagueTale implements OnInit {
  ...
  listaComentarios: Comentario[] = [
    {
      ...
      avatar: 'A',
      estrelas: 5,
      texto: 'Uma obra-prima narrativa! A atmosfera da França medieval sombria combinada com os ratos é assustadoramente linda.',
      data: '21/08/2026',
      likes: 95,
      dislikes: 1,
    },
    {
      ...
      avatar: 'H',
      estrelas: 5,
      texto: 'História muito emocionante que prende do começo ao fim. Trilha sonora espetacular.',
      data: '19/08/2026',
      likes: 62,
      dislikes: 2,
    },
  ...
  readonly ID_PRODUTO = '7';
  readonly precoJogo = 103.93;
  readonly precoOriginalFormatado = 'R$ 159,90';
  readonly precoFormatado = 'R$ 103,93';
  ...
  private jogoSlug = 'a-plague-tale-innocence';
  private steamAppId = '752590';
    ...
    this.rawgService.obterDetalhesJogo(this.jogoSlug).subscribe({
      next: (res: any) => {
        this.jogo = {
          id: res.id,
          nome: res.name,
          descricao: `Siga a sombria história da jovem Amicia e seu irmão mais novo, Hugo, em uma jornada comovente pela darkest era da história francesa. Perseguidos por soldados da Inquisição e cercados por enxames implacáveis de ratos que espalham a Peste Negra, Amicia e Hugo aprenderão a confiar um no outro. Lutando contra adversidades impossíveis, eles combaterão o medo e lutarão para sobreviver em um mundo brutal que busca destruí-los.`,
          dataLancamento: res.released ? res.released.split('-').reverse().join('/') : '14/05/2019',
          desenvolvedoras: res.developers?.[0]?.name || 'Asobo Studio',
          distribuidoras: res.publishers?.[0]?.name || 'Focus Entertainment',
